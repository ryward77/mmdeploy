class ConvModule(Module):
  ...
  activate : __torch__.torch.nn.modules.activation.___torch_mangle_5.ReLU
  def forward(self: __torch__.mmcv.cnn.bricks.conv_module.___torch_mangle_6.ConvModule,
